...
export const HeroSlider = () => {
  ...
  const handleCTAClick = (path: string) => {
    if (!isAuthenticated && (path.includes("/dashboard") || path.includes("/qr"))) {
      navigate("/auth");
    } else {
      navigate(path);
    }
            ...
            <div className="text-center text-white">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
                <Button
                  ...
                  className="bg-white text-primary hover:bg-white/95 text-base md:text-lg px-8 py-6 md:px-10 md:py-7 shadow-emergency hover:shadow-xl transition-all duration-300 font-bold min-w-[220px] group"
                ...
                <Button
                  ...
                  className="border-2 border-white text-white hover:bg-white hover:text-primary text-base md:text-lg px-8 py-6 md:px-10 md:py-7 backdrop-blur-sm transition-all duration-300 font-semibold min-w-[220px]"
