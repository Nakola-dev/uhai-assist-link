...
import { Activity, Heart, Shield, Smartphone, QrCode, MessageSquare, AlertCircle } from "lucide-react";
        ...
        <section className="relative overflow-hidden bg-gradient-to-br from-primary via-primary-glow to-accent min-h-[80vh] flex items-center">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-3xl mx-auto text-center text-white">
              <div className="inline-flex items-center gap-2 mb-6 px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm animate-fade-in">
                <Activity className="h-5 w-5" />
                <span className="font-medium">Smart Emergency Response Powered by AI</span>
              </div>
              ...
              <p className="text-xl mb-8 text-white/90 animate-fade-in">
                When every second counts, UhaiLink provides AI-guided first aid and secure medical data through QR wristbands. Built for Africa's emergency challenges.
              </p>
